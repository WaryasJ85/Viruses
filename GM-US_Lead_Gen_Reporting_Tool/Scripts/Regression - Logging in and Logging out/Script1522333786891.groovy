...
WebUI.mouseOver(findTestObject('Page_Home Page - US Leadgen/a_Sign In'))
...
WebUI.mouseOver(findTestObject('Page_Home Page - US Leadgen (1)/span_Account'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_Home Page - US Leadgen (2)/span_Sign Out'))
